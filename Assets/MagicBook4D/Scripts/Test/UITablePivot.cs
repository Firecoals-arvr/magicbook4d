...
public class UITablePivot : UIWidgetContainer
{
    ...
    /// <summary>
    /// Table vertical pivot
    /// </summary>
    public PivotVertical pivotVertical = PivotVertical.Middle;
    ...
    public void RepositionPivot(List<Transform> children)
    {
        ...
        float Height = 0;
        if (pivotVertical != PivotVertical.Middle)
            Height = NGUIMath.CalculateRelativeWidgetBounds(transform).size.y;
        ...
        for (int i = 0, imax = children.Count; i < imax; ++i)
        {
            ...
            float childHeight = NGUIMath.CalculateRelativeWidgetBounds(t).size.y;
            if (pivotVertical == PivotVertical.Up)
                pos.y += Height / 2 - childHeight / 2;
            else if (pivotVertical == PivotVertical.Down)
                pos.y -= Height / 2 - childHeight / 2;
