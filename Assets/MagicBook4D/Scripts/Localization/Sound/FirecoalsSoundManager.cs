...
namespace Firecoals.AssetBundles.Sound
{
    ...
    public class FirecoalsSoundManager : MonoBehaviour
    {
        ...
        private static FirecoalsSoundManager instance = null;
        ...
        private static FirecoalsSoundManager Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = (FirecoalsSoundManager)FindObjectOfType(typeof(FirecoalsSoundManager));
                    if (instance == null)
                    {
                        // Create gameObject and add component
                        instance = (new GameObject("EazySoundManager")).AddComponent<FirecoalsSoundManager>();
                    }
                }
                return instance;
            }
