...
namespace Firecoals.Color
{
	public class ForestTrackableHandler : DefaultTrackableEventHandler
	{
		...
		{
            GameObject go = _assetLoader.LoadGameObjectSync("color/model/khurung","Assets/ColorAR/Prefabs/KhuRung/KhuRung_Group.prefab");
            ...
            if (go)
            {
                ...
                forest.GetComponentsInChildren<RC_Get_Texture>(true, lst);
